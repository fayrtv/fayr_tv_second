...
export const CHIME_ROOM_API = "https://48ms4plj0l.execute-api.eu-west-3.amazonaws.com/Prod/ ";
...
export const CHAT_WEBSOCKET = "wss://k2qnhjh5w1.execute-api.eu-west-3.amazonaws.com/Prod";
